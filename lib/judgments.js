...
//
// Two feedback loops fire on a judgment:
 ...
 * with `.feedback`, writes the judgment, and runs the corpus promotion/demotion.
 * Returns { ok, judgment_id, promoted } or an { ok:false, ... } problem.
 */
export async function recordJudgment(host, { result_type, result_id, verdict, correction }) {
